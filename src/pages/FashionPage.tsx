...
const FASHION_CATEGORIES = ["mens-shirts", "mens-shoes", "mens-watches", "womens-bags", "womens-dresses", "womens-shoes", "womens-watches", "womens-jewellery", "sunglasses", "tops"];
...
const FashionPage: React.FC = () => {
    ...
    const loadProducts = useCallback(async () => {
        setLoading(true);
        try {
            const promises = FASHION_CATEGORIES.map(category => {
            ...
            toast.error(e.message || "Could not load fashion products.");
        } finally {
            setLoading(false);
        }
    }, [page]);
    ...
    return (
        <div className="py-12 max-w-7xl mx-auto">
            <h1 className="text-4xl font-bold text-center mb-8 dark:text-white">Fashion</h1>
