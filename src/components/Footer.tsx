...
//                 <div>
//                     <h3 className="text-2xl font-bold text-white">BROMART</h3>
//                     <p className="mt-4 text-gray-400">Complete your life with awesome products from us.</p>
...
//                 <p>&copy; {new Date().getFullYear()} BROMART Inc. All rights reserved.</p>
//             </div>
//         </div>
//     </footer>
// );
    ...
    <footer className="bg-gray-900 text-gray-300 dark:bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="bg-accent text-accent-foreground p-10 rounded-2xl text-center mb-16">
                ...
                <p className="mt-2">Get exclusive deals and be the first to know about new collections.</p>
                {/* --- CHANGES START HERE --- */}
                <form className="mt-6 max-w-md mx-auto flex flex-col sm:flex-row gap-4 sm:gap-0">
                    <input 
                        type="email" 
                        placeholder="Enter your email" 
                        className="w-full sm:flex-1 rounded-lg sm:rounded-r-none px-4 py-3 border-black outline-none text-black placeholder:text-gray-500"
                    />
                    <button 
                        type="submit" 
                        className="w-full sm:w-auto bg-primary text-primary-foreground px-6 py-3 rounded-lg sm:rounded-l-none font-semibold hover:bg-opacity-90 transition-colors"
                    >
                        SUBSCRIBE
                    </button>
                </form>
